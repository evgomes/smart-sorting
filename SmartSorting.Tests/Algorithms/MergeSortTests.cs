...
namespace SmartSorting.Tests.Algorithms
{
    ...
    public class MergeSortTests
    {
        ...
        {
            var sortAlgorithm = new MergeSort<float>();
        ...
        {
            var sortAlgorithm = new MergeSort<decimal>();
        ...
        {
            var sortAlgorithm = new MergeSort<double>();
        ...
        {
            var sortAlgorithm = new MergeSort<string>();
        ...
        {
            var sortAlgorithm = new MergeSort<TodoItem>();
