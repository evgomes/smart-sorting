...
namespace SmartSorting.Tests.Algorithms
{
    ...
    public class HeapSortTests
    {
        ...
        {
            var sortAlgorithm = new HeapSort<int>();
        ...
        {
            var sortAlgorithm = new HeapSort<float>();
        ...
        {
            var sortAlgorithm = new HeapSort<decimal>();
        ...
        {
            var sortAlgorithm = new HeapSort<double>();
        ...
        {
            var sortAlgorithm = new HeapSort<string>();
        ...
        {
            var sortAlgorithm = new HeapSort<TodoItem>();
