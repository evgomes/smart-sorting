...
namespace SmartSorting.Tests.Algorithms
{
    ...
    public class InsertionSortTests
    {
        ...
        {
            var sortAlgorithm = new InsertionSort<float>();
        ...
        {
            var sortAlgorithm = new InsertionSort<decimal>();
        ...
        {
            var sortAlgorithm = new InsertionSort<double>();
        ...
        {
            var sortAlgorithm = new InsertionSort<string>();
        ...
        {
            var sortAlgorithm = new InsertionSort<TodoItem>();
