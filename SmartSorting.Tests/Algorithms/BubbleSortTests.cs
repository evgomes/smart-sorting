...
namespace SmartSorting.Tests.Algorithms
{
    ...
    public class BubbleSortTests
    {
        ...
        {
            var sortAlgorithm = new BubbleSort<float>();
        ...
        {
            var sortAlgorithm = new BubbleSort<decimal>();
        ...
        {
            var sortAlgorithm = new BubbleSort<double>();
        ...
        {
            var sortAlgorithm = new BubbleSort<string>();
        ...
        {
            var sortAlgorithm = new BubbleSort<TodoItem>();
