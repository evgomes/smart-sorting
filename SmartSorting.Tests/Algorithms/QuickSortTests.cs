...
namespace SmartSorting.Tests.Algorithms
{
    ...
    public class QuickSortTests
    {
        ...
        {
            var sortAlgorithm = new QuickSort<float>();
        ...
        {
            var sortAlgorithm = new QuickSort<decimal>();
        ...
        {
            var sortAlgorithm = new QuickSort<double>();
        ...
        {
            var sortAlgorithm = new QuickSort<string>();
        ...
        {
            var sortAlgorithm = new QuickSort<TodoItem>();
